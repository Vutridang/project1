						...
						<div class="right-content">
							...
							@if (Auth::check())
                                   ...
                                   @else
                                         ...
                                         <li><i class="ti-user"></i> <a href="{{ route('home.register') }}">Đăng ký</a></li>
                                   @endif
							</ul>
						</div>
						<!-- End Top Right -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="index.html"><img src="{{asset('home/home/images/logo.png')}}" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
							...
							<div class="search-bar">
								...
								<select name="id">
									...
									@foreach($categorys as $category)
									    <option value="{{$category->id}}" @if(Request::has('q') && Request::input('id') == $category->id)selected @endif>{{$category->name}}</option>
									@endforeach
								</select>
							...
							<div class="sinlge-bar shopping">
								...
								<div class="shopping-item">
									...
									<div class="bottom">
										<div class="total">
											<span>Tổng tiền :</span>
											<span class="total-amount">{{$cartSubTotal}}</span>
										</div>
...
<li class="@if(Request::fullUrl() == route('home')) active @endif">
	<a href="{{route('home')}}">Trang chủ</a>
</li>
     @foreach($categorys as $category)
<li class="@if(Request::fullUrl() == route('home.category.get',[$category->slug])) active @endif">
     @if($category->childrenRecursive()->count())
  <a href="{{route('home.category.get',[$category->slug])}}">
	  {{$category->name}}
  ...
  <ul class="dropdown">
	@foreach($category->childrenRecursive as $k => $children)
	    <li>
	    	<a href="{{route('home.category.get',[$children->slug])}}">{{$children->name}}</a>
	    </li>
	@endforeach
  </ul>
   @else
