...
<div class="row">
  <div class="call-md-12">
    <div class="box box-primary">
            ...
            <form method="POST" action="{{route('admin.product.add.store')}}" enctype="multipart/form-data">
            <!-- /.box-header -->
            @csrf
            <div class="box-body">
              ...
              <div class="form-group @if($errors->has('number')) has-error @endif">
                ...
                <input type="text" name="number" class="form-control" value="{{old('number')}}" placeholder="Nhập số lượng">
              </div>
              <div class="form-group @if($errors->has('number')) has-error @endif">
                <label for="exampleInputEmail1">Gía tiền</label>
                <input type="text" name="price" class="form-control" value="{{old('price')}}" placeholder="Nhập giá tiền">
              </div>
